...
for Id in Id_list:
	...
	pattern1 = re.compile(r'Patch Set 1: Abandoned') 					# "abandoned" 
	pattern2 = re.compile(r'Change has been successfully cherry-picked') # "Change has been successfully cherry-picked as"
	flag1 = 0
	flag2 = 0
	for line in lines:
		#print type(line)
